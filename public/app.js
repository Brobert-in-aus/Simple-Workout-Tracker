...
async function loadTemplate() {
  ...
  for (const tmpl of templates) {
    ...
    header.addEventListener('click', () => {
      ...
      // Always re-fetch when opening so linked-template indicators (and any
      // other server-side state) stay current even if another template changed
      // since this body was last rendered.
